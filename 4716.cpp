...
int main()
{
    ...
    while (1)
    {
        ...
        MinCostMaximumFlow MCMF(n);

        MCMF.add_edge(MCMF.a, MCMF.sink, a, 0);
        MCMF.add_edge(MCMF.b, MCMF.sink, b, 0);
        ...
        for (int i = 1; i <= n; i++)
        {
            ...
            MCMF.add_edge(MCMF.source, i, k, 0);
            MCMF.add_edge(i, MCMF.a, INF, da);
            MCMF.add_edge(i, MCMF.b, INF, db);
        }
